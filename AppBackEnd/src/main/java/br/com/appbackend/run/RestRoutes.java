...
public class RestRoutes {
	...
	public static void main(String[] args) {
		...
		get("/alunos/:inst/:course/:year/:half", (request, response) ->
		{			
            ...
            {
            	//atributo RA
				year  = Integer.getInteger(request.params("year"));
            	half = Integer.getInteger(request.params("half"));
