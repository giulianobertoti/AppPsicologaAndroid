...
public class StudentModel
{
  ...
  //Método que enviará a requisição GET ao WebService e retornará um estudante com suas competências
    ...
    public static List<Student> searchByCourseYearAndHalf(String instituition,String course, int year, int half)
    {
        /*
        * Conexão no webService para busca de estudantes.
        * */
        String url = "http://localhost:4567/alunos/"+instituition+"/"+course+"/"+year+"/"+half+"/";
